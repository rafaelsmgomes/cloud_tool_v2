export const animateStuff = (btnVal) => {
	...
	if(btnVal === 1){
		...
		setTimeout(function(){
			...
			$('.btn__regress--2').addClass('activate');
		},7500);		
	}
		else if(btnVal === 2){
		...
		setTimeout(function(){
			...
			$('.btn__regress--3').addClass('activate');				
		},7500);		
	}
	else if(btnVal === 3){
		...
		setTimeout(function(){
			...
			$('.btn__regress--5').addClass('activate');				
		},6000-1000);		
	}else if(btnVal === 5){
		...
		setTimeout(function(){
			...
			$('.btn__regress--6').addClass('activate');						
		},6000-1000);		
	}else if(btnVal === 6){
		...
		setTimeout(function(){
			...
			$('.btn__regress--7').addClass('activate');				
		},7500);	
	}else if(btnVal === 7){
